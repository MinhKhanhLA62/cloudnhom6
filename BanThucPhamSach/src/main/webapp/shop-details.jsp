...
function addToCart(url) {
    ...
    window.location.href = url + "?maSP=${oneSanPham.getMaSP()}&soLuong=" + quantity;
}
</script>
</head>
				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							<a href="trang-chu">Home</a> <span>Thông tin sản phẩm</span>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="product__details__pic">
						<div class="product__details__pic__item">
							<img class="product__details__pic__item--large"
								src="${pageContext.request.contextPath}/img/ImageSP/${oneSanPham.getHinhAnh()}"
								alt="">
						</div>
						<div class="product__details__pic__slider owl-carousel">
							<c:forEach items="${ngauNhien4SanPham}" var="sp">
								<a href="thong-tin-san-pham?maSP=${sp.getMaSP()}"> <img
									data-imgbigurl="${pageContext.request.contextPath}/img/ImageSP/${sp.getHinhAnh()}"
									src="${pageContext.request.contextPath}/img/ImageSP/${sp.getHinhAnh()}"
									alt="">
								</a>
							</c:forEach>
						</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="product__details__text">
						...
						<div class="product__details__rating">
							<div>${oneSanPham.getDanhGia()}
								<i class="fa fa-star"></i>
							</div>

							<%-- <span>${oneSanPham.getLuotDanhGia()}</span> --%>
						</div>
						<div class="product__details__price">${oneSanPham.getGiaDaGiam()}
							VND</div>
                        ...
                        <a href="javascript:void(0);" onclick="addToCart('<c:url value="/them-vao-gio"/>')" class="primary-btn">Thêm vào giỏ hàng</a>
						...
						<div class="product__item">
							<div class="product__item__pic set-bg"
								...
								<ul class="product__item__pic__hover">
									...
									<li><a href="thong-tin-san-pham?maSP=${sp.getMaSP()}"><i
							...
							<div class="product__item__text">
								<h6>
									<a href="thong-tin-san-pham?maSP=${sp.getMaSP()}">${sp.getTenSP()}</a>
								</h6>
								<h5>${sp.getGiaSP()}</h5>
							</div>
						</div>
