                                   ...
                                   <%--  <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input id="priceInput" name="Gia" type="number" min="0" class="col-md-12 form-control border-input" oninput="validateInput('priceInput', 'Giá sản phẩm phải lớn hơn 0', errorMsgPrice)">  
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input id="soLuongInput" name="soLuong" type="number" min="0" class="col-md-12 form-control border-input" oninput="validateInput('soLuongInput', 'Số lượng tồn kho phải lớn hơn 0', errorMsgSoLuong)">  
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>	
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input id="PhantramgiamgiaInput" name="giamGia" type="number" class="col-md-12 form-control border-input" oninput="validateInput('PhantramgiamgiaInput', 'Phần trăm giảm giá phải lớn hơn 0', errorMsgPhantramgiamgia)">  
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
